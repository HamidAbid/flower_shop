...
const bouquetRecommendations = {
  romantic: [
    ...
    },
    {
      ...
      details: {
        flowers: ['Pink Roses', 'White Roses', 'Baby\'s Breath'],
        size: 'Medium',
  ...
  sympathy: [
    ...
    },
    {
      ...
      details: {
        flowers: ['Pink Roses', 'White Carnations', 'Baby\'s Breath'],
        size: 'Medium',
        care: 'Change water every 2-3 days, keep in cool place',
        occasion: 'Sympathy, Condolences, Memorial',
        delivery: 'Same day delivery available'
  ...
  getWell: [
    ...
    },
    {
      ...
      details: {
        flowers: ['Pink Roses', 'White Lilies', 'Baby\'s Breath'],
        size: 'Medium',
        care: 'Change water every 2-3 days, keep in cool place',
        occasion: 'Get Well, Recovery',
        delivery: 'Same day delivery available'
    ...
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <nav className="flex mb-8 text-sm">
          ...
          <Link to="/quiz" className="text-gray-500 hover:text-gray-700">Quiz</Link>
          <span className="mx-2 text-gray-500">›</span>
            ...
            <div className="p-6 flex flex-col">
              ...
              <div className="border-t border-gray-200 pt-6">
                ...
                <div className="space-y-4">
                  <div>
                    <h3 className="text-sm font-medium text-gray-500">Flowers Included</h3>
                    <p className="mt-1 text-gray-900">{product.details.flowers.join(', ')}</p>
                  </div>
                  <div>
                  ...
                  <div>
                    <h3 className="text-sm font-medium text-gray-500">Perfect For</h3>
                    <p className="mt-1 text-gray-900">{product.details.occasion}</p>
                  </div>
                  <div>
                    <h3 className="text-sm font-medium text-gray-500">Delivery</h3>
                    <p className="mt-1 text-gray-900">{product.details.delivery}</p>
                  </div>
                </div>
              </div>
            </div>
