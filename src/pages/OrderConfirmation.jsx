      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="px-6 py-8">
            ...
            <div className="border-b border-gray-200 pb-6 mb-6">
              ...
              <div className="space-y-4">
                {order.items.map((item, index) => (
                  <div key={index} className="flex border-b border-gray-100 pb-4 last:border-b-0 last:pb-0">
                    <img
                      src={item.image}
                      alt={item.name}
                    ...
                    <div className="ml-4 flex-1">
                      ...
                      {item.type === 'custom' && (
                        <p className="text-xs text-purple-600">Custom Bouquet</p>
                      )}
                    </div>
                  </div>
                ))}
              ...
              <div className="mt-6 space-y-2">
                <div className="flex justify-between text-sm">
                  ...
                  <p className="font-medium">${order.summary.subtotal.toFixed(2)}</p>
                </div>
                <div className="flex justify-between text-sm">
                ...
                <div className="flex justify-between text-sm">
                  ...
                  <p className="font-medium">${order.summary.tax.toFixed(2)}</p>
                </div>
                ...
                <ol className="space-y-4">
                  <li className="flex">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">We'll send a confirmation email to {order.customer.email}</p>
                    </div>
                  </li>
                  <li className="flex">
                    <div className="bg-green-100 rounded-full h-8 w-8 flex items-center justify-center text-green-600 mr-3 flex-shrink-0">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Our florists will carefully prepare your bouquet</p>
                    </div>
                  </li>
                  <li className="flex">
                    <div className="bg-green-100 rounded-full h-8 w-8 flex items-center justify-center text-green-600 mr-3 flex-shrink-0">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Your flowers will be delivered by {formatDate(deliveryDate)}</p>
                    </div>
                  </li>
                </ol>
              </div>
            ...
            <div className="mt-8 flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-4">
              ...
              <button
                ...
                className="btn-secondary py-2 px-6 flex items-center justify-center"
              >
        ...
        <div className="mt-6 text-center">
          <p className="text-gray-600">
            ...
            Contact our customer support at <span className="text-primary font-medium">support@bloomandbeyond.com</span> or call <span className="text-primary font-medium">+1 234 567 8900</span>
          </p>
        </div>
      </div>
    </div>
